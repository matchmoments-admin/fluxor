...
Fluxor is a browser-based IDE inspired by Cursor AI, featuring:
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/brendan-milton/fluxor.git
   cd fluxor
   ```
...
4. Configure your `.env.local` with the required keys:
   ...
   CONVEX_DEPLOYMENT=
   FLUXOR_CONVEX_INTERNAL_KEY=  # Generate a random string
